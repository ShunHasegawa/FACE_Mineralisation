...
\noindent
<<Stat_FACE_Mine_N_minSmmry_preCO2, echo=TRUE, results='markup'>>=
@


\subsubsection{Post-CO$_2$}
\noindent
<<Stat_FACE_Mine_N_minSmmry_postCO2, echo=TRUE, results='markup'>>=
@

\subsubsection{ANCOVA with soil variables}
\noindent
<<Stat_FACE_Mine_N_min_withSoilvarSmmry, echo=TRUE, results='markup', fig.show='asis', fig.width = 6, fig.height = 4>>=
@
